            ...
            val headerContent: @Composable (textButton: (@Composable () -> Unit)?) -> Unit =
                { textButton ->
                    if (artist?.timestamp == null) {
                        ...
                        Header(title = artist?.name ?: "Неизвестно") {
                            textButton?.invoke()
                    ...
                    when (currentTabIndex) {
                        ...
                        2 -> {
                            ...
                            ItemsPage(
                                ...
                                headerContent = headerContent,
                                emptyItemsText = "Этот исполнитель не выпустил ни одного альбома",
                                itemsPageProvider = artistPage?.let {
                                    ({ continuation ->
                                        continuation?.let {
                                            Innertube.itemsPage(
                        ...
                        3 -> {
                            ...
                            ItemsPage(
                                ...
                                headerContent = headerContent,
                                emptyItemsText = "Этот артист не выпустил ни одного сингла",
                                itemsPageProvider = artistPage?.let {
                                    ({ continuation ->
                                        continuation?.let {
                                            Innertube.itemsPage(
